    ...
    <div class="row">
        ...
        <div class="col-md-10" >
            ...
            <div class="index_conteudo">
                ...
                <form method="post" name="form_desbravador" id="form_desbravador" action="/quarentenas/{{ $quarentena->id }}" >
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" value="{{ $quarentena->pontos }}" id="pontos" name="pontos" aria-describedby="pontos" placeholder="pontos">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" value="{{ $quarentena->descricao }}"  id="descricao" name="descricao" aria-describedby="descricao" placeholder="descricao">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text"  required class="form-control date" value="{{ $quarentena->data_pontos }}" id="data_pontos" name="data_pontos" aria-describedby="data pontos" placeholder="Data Pontos" >
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="usuario" required  name="usuario_id" class="form-control" >
                                        @foreach($usuarios as $usuario)
                                            <option value="{{ $usuario->id }}" {{ ($usuario->id == $quarentena->usuario_id)? 'selected' : '' }} >{{ $usuario->nome }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
