                    ...
                    <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $pontoIndividual->pontos }}" id="pontos" name="pontos" aria-describedby="pontos" placeholder="pontos">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $pontoIndividual->descricao }}"  id="descricao" name="descricao" aria-describedby="descricao" placeholder="descricao">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" class="form-control date" value="{{ $pontoIndividual->data_pontos }}" id="data_pontos" name="data_pontos" aria-describedby="data pontos" placeholder="Data Pontos" >    
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select id="usuario" value="{{ $pontoIndividual->usuario_id }}" name="usuario_id" class="form-control" >
