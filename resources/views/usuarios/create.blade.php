    ...
    <div class="row">
        ...
        <div class="col-md-10" >
            ...
            <div class="index_conteudo">
                ...
                <form method="post" name="form_desbravador" id="form_desbravador" action="/usuarios" enctype="multipart/form-data" >
                    {{ csrf_field() }}

                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ asset('assets/imagens/user_icon.png') }}" class="imagem_perfil" name="foto_imagem" id="foto_imagem" />
