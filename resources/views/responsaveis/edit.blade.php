                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="telefone" name="tel" value="{{ $responsavel->tel }}" aria-describedby="Telefone" placeholder="Telefone" >
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="celular" name="cel" value="{{ $responsavel->cel }}" aria-describedby="Celular" placeholder="Celular" >
                                </div>
                            </div>
                            <!-- linha de baixo -->
